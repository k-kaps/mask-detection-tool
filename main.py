...
face_library = cv2.CascadeClassifier('C:/Users/karan/Software Projects/Mask Detection Tool/haarcascade_frontalface_default.xml')
eye_library = cv2.CascadeClassifier('C:/Users/karan/Software Projects/Mask Detection Tool/haarcascade_righteye_2splits.xml')
mouth_library = cv2.CascadeClassifier('C:/Users/karan/Software Projects/Mask Detection Tool/haarcascade_smile.xml')
...
while loop:
    ...
    faces = face_library.detectMultiScale(img_gray, scaleFactor = 1.1, minNeighbors = 5)
    eyes = eye_library.detectMultiScale(img_gray, scaleFactor = 1.1, minNeighbors = 7)
    mouth = mouth_library.detectMultiScale(img_gray, scaleFactor = 1.21, minNeighbors = 22)
    face_no = len(faces)
    eye_no = len(eyes)
    mouth_no = len(mouth)
